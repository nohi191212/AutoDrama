...
def main(argv: list[str] | None = None) -> int:
    ...
    payload = provider.build_payload(
        ...
        refs=[
            AssetRef(id="reference", type="image", url="https://example.invalid/reference-image.png"),
    ...
    assert payload["content"][1]["image_url"]["url"] == "https://example.invalid/reference-image.png"
