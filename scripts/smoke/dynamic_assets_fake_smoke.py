...
async def main_async() -> int:
    ...
    if '"assets/audios/shot_bgms/' not in episode_001_shot_text:
        raise AssertionError("episode_001 shot missing shot BGM")
    ...
    if '"assets/audios/shot_bgms/' in episode_002_shot_text:
        raise AssertionError("episode_002 BGM was generated despite generate=false")
    ...
    required_paths = [
        project_dir / "assets" / "json" / "nodes" / "shot_bgm_generation.json",
    ...
    if items["episode_001"]["node_status"]["shot_bgm"] != "completed":
        raise AssertionError("episode_001 shot BGM should be completed by default")
    ...
    if not shot_bgms:
        raise AssertionError("No shot BGM generated")
    if shot_audios:
