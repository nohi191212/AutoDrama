Read the complete screenplay below and extract the story's dominant genre and world setting for a visual generation model.

Focus on stable world-level traits that can represent the whole screenplay: genre, era, geography, social order, technology or supernatural rules, architecture or natural environment, and recurring atmosphere. Ignore the plot timeline. Do not include character names, character descriptions, dialogue, individual actions, episode events, specific story props, twists, or a description of one scene.
...
Do not output Markdown, explanations, translations, extra fields, non-English text, or reasoning.
