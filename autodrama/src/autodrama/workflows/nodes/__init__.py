...
from autodrama.workflows.nodes.shot_bgm_node import SHOT_BGM_NODE_NAME, build_shot_bgm_episode_node
...
def build_generation_episode_nodes(workflow: Any) -> list[EpisodeWorkflowNode]:
    return [
        ...
        build_shot_bgm_episode_node(workflow),
