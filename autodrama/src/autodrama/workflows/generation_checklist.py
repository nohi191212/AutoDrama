...
from autodrama.core.schemas import ProjectState, ShotManifestEpisodeOutput
...
def _load_shot(project_dir: Path, episode_key: str) -> ShotManifestEpisodeOutput | None:
