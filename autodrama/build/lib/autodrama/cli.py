...
def build_parser() -> argparse.ArgumentParser:
    ...
    import_parser.add_argument(
        ...
        help=(
            ...
            "script_novel_extract, script_worldview_extract, key_vision_prompt, key_vision_image_generation, "
            "and dynamic generation nodes are marked stale."
        ),
    )
    ...
    pregen_parser.add_argument(
        ...
        help=(
            ...
            "clip_to_shots, layout_to_background_prompt, shot_background_shot_reference, shot_background_image_generation, shot_keyframe_prompt, shot_keyframe_image_generation, shot_manifest_generation, "
    ...
    pregen_parser.add_argument(
        "--shots",
        help="Comma-separated shot indexes or ids for pregen --only layout_to_background_prompt, shot_background_shot_reference, shot_background_image_generation, shot_keyframe_prompt, shot_keyframe_image_generation, or shot_manifest_generation.",
    )
    pregen_parser.add_argument(
        "--assets",
        help=(
