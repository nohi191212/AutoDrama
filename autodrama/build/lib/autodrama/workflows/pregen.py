    ...
    async def run(
        ...
        *,
        ...
        if explicit_shot_selectors and (
            ...
            raise ValueError("--shots is only supported for pregen --only layout_to_background_prompt, shot_background_shot_reference, shot_background_image_generation, shot_keyframe_prompt, shot_keyframe_image_generation, or shot_manifest_generation.")
