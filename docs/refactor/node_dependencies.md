...
| `prop_extract` | `workflows/nodes/static_asset_nodes.py` | `ProviderRouter.text("prop")`, `AssetService.prop_extract` | Script content helpers, role-bound prop state | `state.metadata.prop_extract`, `state.budget.used_text_calls` | `assets/json/nodes/prop_extract.json` |
