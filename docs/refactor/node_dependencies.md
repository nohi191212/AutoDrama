...
| --- | --- | --- | --- | --- | --- |
| `script_import` | `workflows/nodes/script_nodes.py` (`ScriptImportNode`) | none (pure chapter-file import) | `ScriptChapter` loader, `ScriptContentRepository`, `ProjectRepository.save_node_output` | `state.raw_script`, `state.script.raw_script`, `state.script.novel_full`, `state.script.novel_extract`, `state.metadata.script_import_*` | `assets/json/nodes/script_import.json`; per-episode `assets/json/scripts/novel_full/{episode_key}.json` |
