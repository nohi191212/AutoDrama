...
| --- | --- | --- | --- | --- | --- |
| `script_import` | `workflows/nodes/script_nodes.py` (`ScriptImportNode`) | `ProviderRouter.text("script")`, `ScriptService.script_import` | `ScriptContentRepository`, `ProjectRepository.save_node_output` | `state.script.outline`, `state.script.episode_outlines`, `state.script.novel_full`, `state.metadata.script_import_*`, `state.budget.used_text_calls` | `assets/json/nodes/script_import.json`; per-episode `assets/json/scripts/outlines/{episode_key}.json`; per-episode `assets/json/scripts/novel_full/{episode_key}.json` |
